...
def gelu(x):
    ...
    For information: OpenAI GPT's gelu is slightly different (and
...
class BERTLayerNorm(nn.Module):
    def __init__(self, config, variance_epsilon=1e-12):
        """Construct a layernorm module in the TF style (epsilon
...
class BERTEmbeddings(nn.Module):
    def __init__(self, config):
        ...
        """Construct the embedding module from word, position and token
        type embeddings.
        """
...
class BertModel(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None):
        ...
        # for masked positions, this operation will create a tensor which is 0
