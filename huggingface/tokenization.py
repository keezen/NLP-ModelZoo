...
class BasicTokenizer(object):
    ...
    def tokenize(self, text):
        ...
        # doesn't matter since the English models were not trained on any
        # Chinese data and generally don't have any Chinese data in them (there
        # are Chinese characters in the vocabulary because Wikipedia does have
    ...
    def _is_chinese_char(self, cp):
        ...
        # treatedspecially and handled like the all of the other languages.
